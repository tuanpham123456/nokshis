                    ...
                    <ul class="sidebar-menu" data-widget="tree">
                        <li class="active treeview">
                            ...
                            <ul class="treeview-menu" style="display: none;">
                              <li><a href="{{ route('admin.category.index') }}"><i class="fa fa-list"></i>List category</a></li>
                            </ul>
                          </li>
                    </ul>
                    <ul class="sidebar-menu" data-widget="tree">
                        <li class="active treeview">
                            ...
                            <ul class="treeview-menu" style="display: none;">
                              <li><a href="{{ route('admin.keyword.index') }}"><i class="fa fa-list"></i>List keyword</a></li>
                            </ul>
                          </li>
                    </ul>
                    <ul class="sidebar-menu" data-widget="tree">
                        <li class="active treeview">
                            ...
                            <ul class="treeview-menu" style="display: none;">
                              <li><a href="{{ route('admin.product.index') }}"><i class="fa fa-list"></i>List product</a></li>
                            </ul>
                          </li>
                    </ul>
                </section>
